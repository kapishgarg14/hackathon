    ...
    <>
      {loading ? <Loader /> : (
        <>
          ...
          <hr></hr>
            <img src='https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.FCV9tdVAJ-GWM-nzSG565QHaE8%26pid%3DApi&f=1' alt='default' className='docImg' />
            
            <Container className = "badCon">
              <div className='dummyDesc'>
                    <h3 className='mb-4'>HEALTH AT HOME</h3>
                    <p>
...
Healthcare providers can also harness the power of 'Company name' as the platform that helps them build their presence, grow establishments, and engage patients more deeply than ever.
              ...
              <div classname = "pseudo">
                  <Row sm = {2}>
                  <div>
                  <img src = 'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.usnews.com%2Fcmsmedia%2Fd1%2F49%2F1177902948429441476b834e014f%2F150413-doctor-stock.jpg&f=1&nofb=1' className = 'viewImage'></img>
                  </div>
                  <div>
                      <h1>
                          Diverse Minds One Purpsoe
                      </h1>
                      <p>
              ...
              <div className =  "lastkarona">
                  <h1 className = "h1bottom">HEALTH COMES FIRST</h1>
                  <p>
...
Our motivation comes from the 4H – help, heal, healthy, happy.
              ...
              <div className =  "lastkarona">
                  <h1 className = "h1bottom">How are we coping with COVID-19?</h1>
